function Icone({ icone, largura }) {
    ...
    const carrinho = 
    <svg width={largura ? largura : 44} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    const holder = 
    <svg width={largura ? largura : 44} viewBox="0 0 180 180" fill="none" xmlns="http://www.w3.org/2000/svg">
